...
public class CharonErrorScreen extends Screen {

    private final CharonInstallScreen parent;
    private final Mod mod;
    private DescriptionListWidget description;

    public CharonErrorScreen(CharonInstallScreen parent, Mod mod) {
        super(new TranslatableText("charon.error"));
        this.parent = parent;
        this.mod = mod;
    }
    ...
    protected void init() {
        ...
        this.addButton(new ButtonWidget(this.width / 2 + 4, this.height - 28, 150, 20, new TranslatableText("charon.retry"),
                button -> {
